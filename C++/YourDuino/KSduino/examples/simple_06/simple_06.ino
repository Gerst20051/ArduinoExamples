...
/*
 * KSduino Simple-06 Example Sketch
 *
 * simple_06.ino
 *  
 * KSduino Simple-06 is KSduino-library example sketch
 ...
 * to send D1 parameter to server and KSduinoParameter class to send B1 parameter 
 * to server.
 *
 * This sample demonstrate using of addMessage function.
 *
 */
