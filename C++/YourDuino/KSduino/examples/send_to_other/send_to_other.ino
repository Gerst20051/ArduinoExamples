...
/*
 * KSduino Send to Other Example Sketch
 *
 * send_to_other.ino
 *  
 * KSduino Send to Other is KSduino-library example sketch
 ...
 *
 * To execute this test D1, B1, B2 Device parameters should be createt at KSduino server.
 *
...
byte mac[] = { 0xDE, 0xAD, 0xBE, 0xEF, 0xAE, 0x0D };
...
void loop()
{
  ...
  if (send_b1) ksd.sendToOther (deviceID, devicePwd-devicePwd+1, "b2", b_value, "Received from other devices");   
