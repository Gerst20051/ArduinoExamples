...
/*
 * KSduino Simple-03 Example Sketch
 *
 * simple_03.ino
 *  
 * KSduino Simple-03 is KSduino-library example sketch
 ...
 * This sample used sendBuffer with String object function to send data 
 * to server
 *
 */
